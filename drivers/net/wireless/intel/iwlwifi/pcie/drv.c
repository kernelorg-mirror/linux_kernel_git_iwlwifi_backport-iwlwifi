...
/* FM RF */
	...
	IWL_DEV_INFO(iwl_rf_fm, iwl_be200_name, DEVICE(0x272B)),
...
/* Killer */
	IWL_DEV_INFO(iwl_rf_fm, iwl_killer_be1750w_name, SUBDEV(0x1773)),
	IWL_DEV_INFO(iwl_rf_fm, iwl_killer_be1750x_name, SUBDEV(0x1774)),
