...
#define IWL_MVM_VENDOR_RSSI_THRESHOLD_MAX	-62
#define IWL_MVM_VENDOR_RSSI_THRESHOLD_MIN	-67
...
#define IWL_MVM_FTM_TEST_INCORRECT_SAC		(mvm->trans->dbg_cfg.MVM_FTM_TEST_INCORRECT_SAC)
#define IWL_MVM_FTM_TEST_BAD_SLTF		(mvm->trans->dbg_cfg.MVM_FTM_TEST_BAD_SLTF)
...
#define IWL_MVM_HIGH_RSSI_THRESH_20MHZ		(mvm->trans->dbg_cfg.MVM_HIGH_RSSI_THRESH_20MHZ)
#define IWL_MVM_LOW_RSSI_THRESH_20MHZ		(mvm->trans->dbg_cfg.MVM_LOW_RSSI_THRESH_20MHZ)
#define IWL_MVM_HIGH_RSSI_THRESH_40MHZ		(mvm->trans->dbg_cfg.MVM_HIGH_RSSI_THRESH_40MHZ)
#define IWL_MVM_LOW_RSSI_THRESH_40MHZ		(mvm->trans->dbg_cfg.MVM_LOW_RSSI_THRESH_40MHZ)
#define IWL_MVM_HIGH_RSSI_THRESH_80MHZ		(mvm->trans->dbg_cfg.MVM_HIGH_RSSI_THRESH_80MHZ)
#define IWL_MVM_LOW_RSSI_THRESH_80MHZ		(mvm->trans->dbg_cfg.MVM_LOW_RSSI_THRESH_80MHZ)
#define IWL_MVM_HIGH_RSSI_THRESH_160MHZ		(mvm->trans->dbg_cfg.MVM_HIGH_RSSI_THRESH_160MHZ)
#define IWL_MVM_LOW_RSSI_THRESH_160MHZ		(mvm->trans->dbg_cfg.MVM_LOW_RSSI_THRESH_160MHZ)
