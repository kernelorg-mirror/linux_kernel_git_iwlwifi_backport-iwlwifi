...
/**
 * struct iwl_mac_base - params not likely to change within a device family
...
/**
 * struct iwl_mac_cfg - information needed to start the trans
 *
 ...
 */
struct iwl_mac_cfg {
	const struct iwl_mac_base *base;
