...
{
	struct ieee80211_mesh_hwmp_preq_top *top = (void *)(uintptr_t)ie;
...
{
	struct ieee80211_mesh_hwmp_prep_top *top = (void *)(uintptr_t)ie;
...
{
	struct ieee80211_mesh_hwmp_perr *perr_ie = (void *)(uintptr_t)ie;
...
{
	struct ieee80211_mesh_hwmp_perr *perr_elem = (void *)(uintptr_t)pos;
	const u8 *start = pos;
	u8 number_of_dst;
	int needed;
	int i;
	...
	for (i = 0; i < number_of_dst; i++) {
		struct ieee80211_mesh_hwmp_perr_dst *dst = (void *)(uintptr_t)pos;
